...
function Footer({ handleMenuClick }) {
  return (
    <footer className="bg-[#07020e] text-white px-[95px] pt-[80px] pb-[40px] border-t-[0.2px] border-t-[#d640d6] flex flex-col gap-[50px] max-md:px-[30px] max-md:pt-[40px] max-md:pb-[20px]">
      <div className="container mx-auto flex flex-col gap-[25px] max-md:gap-[15px]">
        ...
        <nav>
          <ul className="flex gap-[40px] flex-wrap">
            <li onClick={() => { handleMenuClick("hero"); }}>
              <button className="text-[#FFBFFF] hover:text-[#d640d6] text-[14px] cursor-pointer">Home</button>
            </li>
            <li onClick={() => { handleMenuClick("about"); }}>
              <button className="text-[#FFBFFF] hover:text-[#d640d6] text-[14px] cursor-pointer">About</button>
            </li>
            <li onClick={() => { handleMenuClick("features"); }}>
              <button className="text-[#FFBFFF] hover:text-[#d640d6] text-[14px] cursor-pointer">Features</button>
            </li>
            <li onClick={() => { handleMenuClick("domains"); }}>
              <button className="text-[#FFBFFF] hover:text-[#d640d6] text-[14px] cursor-pointer">Domains</button>
            </li>
            <li onClick={() => { handleMenuClick("services"); }}>
              <button className="text-[#FFBFFF] hover:text-[#d640d6] text-[14px] cursor-pointer">Services</button>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div className="container mx-auto mt-4 text-sm text-gray-400 flex justify-between items-center border-t-[0.2px] border-t-[#d640d6] pt-[20px] max-md:flex-col max-md:items-start max-md:gap-[20px]">
        <p className="text-[#FFBFFF]">© Leapgen Solutions. 2024. All rights reserved. Privacy Policy.</p>
