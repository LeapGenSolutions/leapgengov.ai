...
const Services = () => {
  const services = ["Staff Augmentation", "Development", "Training", "Support"];
  ...
  return (
    <section className="flex flex-col items-center justify-center p-10 bg-[#07020e] pt-[80px]">
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-[80px] max-md:gap-[20px]">
        {services.map((feature) => (
          <h3 className="text-[20px] text-[#ffbfff]">{feature}</h3>
        ))}
      </div>
    </section>
  );
